        ...
        <div class="col-12 col-lg-10 mx-auto">
            ...
            <div class="card card-primary card-outline shadow-sm mb-4">
                <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2 py-3">
                    <h3 class="card-title fw-bold m-0"><i class="bi bi-pencil-square me-2 text-primary"></i>Modify Product Parameters</h3>
                ...
                <div class="card-body p-4 p-md-5">
                    <form method="POST" action="{{ route('products.update', $product) }}" id="productEditForm" novalidate>
                        @csrf
                        @method('PUT')
                        ...
                        <div class="d-flex justify-content-end gap-3 pt-3 border-top">
                            ...
                            <button type="submit" class="btn btn-primary py-2.5 px-4" id="submitBtn">
                                <i class="bi bi-save-fill me-1.5"></i>Save Changes
                            </button>
                        </div>
                    </form>
                </div>
